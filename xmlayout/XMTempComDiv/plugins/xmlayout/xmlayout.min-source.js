		...
		var xmlayout = {
			...
			__createLayout : function(data, panel, deep, panel_tree){
				...
				if(data.lr.length == 2){
					...
					div1.prop({zoom : false, popped : 0, pvalue:"width", key:1, ovalue : mv1, org_data : data.lr[0]});
					var div2 = $('<div style="width:' + mv2 + '%; height:100%; float:left; border-radius: 4px;"></div>');
					div2.prop({zoom : false, popped : 0, pvalue:"width", key:2, ovalue : mv2, org_data : data.lr[1]});
					...
					div1.prop({zoom : false, popped : 0, pvalue:"height", key:1, ovalue : mv1, org_data : data.ud[0]});
					var div2 = $('<div style="height:' + mv2 + '%; width:100%; border-radius: 4px;"></div>');
					div2.prop({zoom : false, popped : 0, pvalue:"height", key:2, ovalue : mv2, org_data : data.ud[1]});
			...
			__addListener : function(panel){
				...
				panel.on("dragstop", function(e1, e){
					...
					pleft.prop("org_data").value = parseInt(v1 * 100);
					pright.prop("org_data").value = parseInt(v3 * 100);
			...
			__addRightPanel : function(panel, def_data){
				...
				upanel.loadElement = function(element, fun, title, style){
					if(element == null || element.length < 1){
						console.error("XMlayout Error : 'element' in function 'loadElement' should not be null!");
						return;
					}
